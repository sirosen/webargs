...
def test_whitespace_stripping_parser_example(web_request):
    ...
    # for this case, json loading should also work because `int("  1")` is
    # allowed, but note that the string list arg won't be adjusted with
    # whitespace even though that's "part of the argument"
